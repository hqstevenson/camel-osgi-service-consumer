...
public class SimpleBuilderRouteTest extends CamelBlueprintTestSupport {
    @EndpointInject( uri = "mock://result")
    MockEndpoint result;

    @Override
    protected String getBlueprintDescriptor() {
        return "/OSGI-INF/blueprint/simple-java-route.xml,/OSGI-INF/blueprint/supporting-beans.xml";
    }
